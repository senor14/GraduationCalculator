...
const GraduationCalculator = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-slate-50 min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="text-lg font-bold text-center text-gray-900 sm:text-xl lg:text-2xl mb-4 sm:mb-6">
          졸업학점 계산기
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-2 px-2">
            <input
              ...
              className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
            />
            <label htmlFor="teachingMajor" className="text-gray-900 text-sm">
              교직이수
            </label>
          </div>
          ...
          <div className="mt-6 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl">
            <div className="text-center">
              <div className="text-lg text-gray-900">잔여 학점</div>
              <div
                className={`text-2xl font-bold ${
                  getTotalRemaining() > 0 ? "text-red-500" : "text-green-500"
                }`}
